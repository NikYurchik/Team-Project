...
class Bot_assistant:
    ...
    def fun_address(self, argv):
        ph = argv[1]
        nm = argv[0].capitalize()
        self.addressbook.address_save(nm, ph)
        return 'Ok'
    
    def fun_full_name(self, argv):
        ph = argv[1]
        nm = argv[0].capitalize()
        self.addressbook.full_name_save(nm, ph)
        return 'Ok'
    ...
    def fun_delemail(self, argv):
        ph = argv[1]
        nm = argv[0].capitalize()
        self.addressbook.email_delete(nm, ph)
        return 'Ok'
